package studyopedia;
import java.util.*;
public class DeleteBankAccountNumber {
	...
	public void deleteBankAccount() {
			...
			for(int i=0;i<arr.length;i++) {
				if(number==arr[i].getAccount_number()) {
	...
	public static void main(String args[]) {
		DeleteBankAccountNumber number=new DeleteBankAccountNumber();
		number.fieldsenter();
		number.deleteBankAccount();
		number.display();
	}
